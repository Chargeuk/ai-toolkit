    ...
    def __init__(self, process_id: int, job, config: OrderedDict, custom_pipeline=None):
        ...
        if self.train_config.cache_text_embeddings:
            for raw_dataset in raw_datasets:
                ...
                raw_dataset['cache_text_embeddings_content_addressed'] = (
                    self.train_config.cache_text_embeddings_content_addressed
                )
    ...
    def run(self):
        ...
        if self.datasets is not None:
            self.data_loader = get_dataloader_from_datasets(
                ...
                self.sd,
                dataset_sampling_strategy=self.train_config.dataset_sampling_strategy,
            )
