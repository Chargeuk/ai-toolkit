    ...
    process: [
      {
        ...
        train: {
          ...
          empty_cuda_cache_before_backward: false,
        ...
        model: {
          ...
          low_vram: false,
          model_kwargs: {},
          layer_offloading_pin_memory: true,
          convrot_backward_save_on_cpu: false,
          convrot_backward_save_expected_layers: 0,
          activation_checkpoint_group_size: 1,
          activation_checkpoint_save_on_cpu: false,
          compile: false,
        },
